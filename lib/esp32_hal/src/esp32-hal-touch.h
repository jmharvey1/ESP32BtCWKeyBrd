...
extern touch_value_t  __attribute__((weak)) touchRead(uint8_t pin);
/*
...
extern void __attribute__((weak)) touchAttachInterrupt(uint8_t pin, void (*userFunc)(void), touch_value_t threshold);
//void touchAttachInterruptArg(uint8_t pin, void (*userFunc)(void*), void *arg, touch_value_t threshold);
extern void __attribute__((weak)) touchAttachInterruptArg(uint8_t pin, void (*userFunc)(void), void *arg, touch_value_t threshold);
//void touchDetachInterrupt(uint8_t pin);
extern void __attribute__((weak)) touchDetachInterrupt(uint8_t pin);

extern void __attribute__((weak)) touchSetCycles(uint16_t measure, uint16_t sleep);
/*
