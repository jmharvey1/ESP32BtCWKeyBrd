...
#include "gpio.h"  //JMH 20230211 added to compile in espidf environment
#include "rom/ets_sys.h"  //JMH 20230211 added to compile in espidf environment
...
Parameters:
hw – Beginning address of the peripheral registers.
baud – The baud-rate to be set. When the source clock is APB, the max baud-rate is `UART_LL_BITRATE_MAX`
sclk_freq – Frequency of the clock source of UART, in Hz.
