...
extern "C" {
#include <Arduino_unistd.h>//#include <sys/unistd.h>//JMH 20230210 modified
#include <sys/stat.h>
#include <dirent.h>
}
...
{
//protected:
    friend class VFSFileImpl; // Note While VFSImpl has not "protected" members, FSImpl does, "const char * _mountpoint;" 
