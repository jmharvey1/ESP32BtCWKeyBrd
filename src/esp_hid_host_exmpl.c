...
void hid_demo_task(void *pvParameters)
{
    ...
    if (results_len) {
        ...
        if (cr)
        {
            ...
            esp_hidh_dev_t *dev = esp_hidh_dev_open(cr->bda, cr->transport, cr->ble.addr_type); // Returns immediately w/ BT classic device; But waits for pairing code w/ BLE device
            if (dev != NULL)
            {
